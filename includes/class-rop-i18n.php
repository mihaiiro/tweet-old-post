	...
	public static function get_labels( $key = '' ) {
		$labels = array(
			...
			'post_format' => array(
				...
				'use_shortner_title'                => __( 'Use url shortner', 'tweet-old-post' ),
				'use_shortner_desc'                 => __( 'Should we use a shortner when adding the links to the content?', 'tweet-old-post' ),
				'use_shortner_yes'                  => __( 'Yes', 'tweet-old-post' ),
				'shortner_title'                    => __( 'URL Shorner Service', 'tweet-old-post' ),
